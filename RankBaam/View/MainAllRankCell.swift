...
class MainAllRankCell: UICollectionViewCell {
    ...
    fileprivate func viewInitConfigure() {
        ...
        mainAllRankCellTitleLabel.font = UIFont(name: "NanumSquareB", size: width375(14))
        ...
        mainAllRankCellWriterNicknameLabel.font = UIFont(name: "NanumSquareB", size: width375(12))
        ...
        mainAllRankVoteCountLabel.font = UIFont(name: "NanumSquareB", size: width375(13))
        ...
        mainAllRankLikeCountLabel.font = UIFont(name: "NanumSquareB", size: width375(13))
